...
class Config(object):
    ...
    API_ID = int(os.environ.get("API_ID",  "28430767"))
    API_HASH = os.environ.get("API_HASH", "14d9ac656b48950febb0d9427d94574e")
    ...
    GROUPS = os.environ.get('GROUPS', '-1002194246890').split(',')
